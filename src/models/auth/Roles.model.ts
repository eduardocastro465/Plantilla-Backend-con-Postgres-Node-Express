...
const RolesModel = {
    ...
    create: async (role: string, description: string | undefined, active: boolean) => {
    ...
    update: async (id: string | number, role: string, description: string | undefined, active: boolean | undefined) => {
    ...
    toggleActivo: async (id: string | number, active: boolean) => {
        const { rowCount } = await pool.query(
