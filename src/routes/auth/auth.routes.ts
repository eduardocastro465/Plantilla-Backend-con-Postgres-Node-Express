...
import { login, register, logout, changePassword, sendEmailCode,validateUsername ,verifyEmailCode, } from '../../controllers/auth/auth.controller.js';
...
router.post('/register/validar-username', authLimiter, validateUsername);
